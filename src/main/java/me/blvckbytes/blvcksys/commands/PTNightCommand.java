...
/*
  ...
  Change the time of your own client to night.
*/
@AutoConstruct
public class PTNightCommand extends APlayerCommand {

  private final IPTimeCommand ptime;

  public PTNightCommand(
  ...
  protected void invoke(Player p, String label, String[] args) throws CommandException {
    ...
    TimeShorthand time = TimeShorthand.NIGHT;
