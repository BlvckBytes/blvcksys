...
1 6reated On: 05/02/2022

  Open a fully usable, virtual enchantment table.
 */
@AutoConstruct
public class EnchantingCommand extends APlayerCommand {
  ...
  public EnchantingCommand(
    ...
    super(
      ...
      PlayerPermission.COMMAND_ENCHANTING.toString()
    );
  ...
  protected void invoke(Player p, String label, String[] args) throws CommandException {
    this.container.openContainer(
      p, ContainerType.ENCHANTING,
      cfg.get(ConfigKey.ENCHANTING_GUINAME)
