...
/*
  ...
  Cast a new permanent ip-ban upon a player.
*/
@AutoConstruct
public class IpBanCommand extends APlayerCommand {
  ...
  protected void invoke(Player p, String label, String[] args) throws CommandException {
    ...
    bans.broadcastBan(bans.createBan(p, target, null, ipAddress, reason));
  }
}
