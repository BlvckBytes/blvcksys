...
/*
  ...
  Change the weather of your own client to storm.
*/
@AutoConstruct
public class PWStormCommand extends APlayerCommand {

  private final IPWeatherCommand pweather;

  public PWStormCommand(
  ...
  protected void invoke(Player p, String label, String[] args) throws CommandException {
    ...
    pweather.setWeather(p, target, PWeatherType.DOWNFALL);
    ...
    if (!target.equals(p))
      p.sendMessage(
        cfg.get(ConfigKey.PWEATHER_SET_OTHERS_SENDER)
          ...
          .withVariable("weather", PWeatherType.DOWNFALL.name())
          .asScalar()
      );
  }
}
