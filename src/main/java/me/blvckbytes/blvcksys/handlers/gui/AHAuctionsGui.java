...
public class AHAuctionsGui extends AGui<Object> {
  ...
  protected boolean opening(GuiInstance<Object> inst) {
    ...
    inst.setPageContents(() -> {
      List<Tuple<AHAuctionModel, Supplier<@Nullable AHBidModel>>> auctions = ahHandler.listAuctions(AuctionCategory.ALL, AuctionSort.NEWEST, null, null, p);
